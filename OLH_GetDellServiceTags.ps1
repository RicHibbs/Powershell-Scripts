...
$thisTag = (Get-WmiObject Win32_BIOS | select serialnumber).Serialnumber

$thiseTag = Get-DellExpressServiceCode $thisTag

Write-Host "Dell Service Tag is $thisTag"
Write-Host "Dell Express Service Tag is $thisetag"